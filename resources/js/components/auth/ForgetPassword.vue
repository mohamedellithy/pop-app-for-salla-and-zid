        ...
        <section class="row" :style="`min-height:755px;background-color: #111827;`">
            ...
            <div class="col-lg-5 text-center">
                <div class="row row-form-ifram">
                    <form method="post" @submit.prevent="SendEmailLink()">
                        <div class="section-login-form">
                            ...
                            <div class="form-group">
                                <label>قم بادخال البريد الالكترونى الخاص بك</label>
...
export default {
    ...
    methods:{
        SendEmailLink:async function(){
            let self = this;
            await axios.post('/api/password/email',this.field).then(function({data}){
                console.log(data);

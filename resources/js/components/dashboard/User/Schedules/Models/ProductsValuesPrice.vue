            ...
            <div class="top-header-model">
                <p class="title-model">
                    <label class="inner-title-model">
                        ...
                        اضافة اسعار الى المنتجات التى قمت يتحديدها
                    </label>
                </p>
            </div>
                        ...
                        <template>
                            ...
                            <tr>
                                <td class="container-check" colspan="6">
                                    ...
                                    <label style="text-align: right;margin-bottom: 15px;"> اضافة سعر مختلف لكل 
                            ...
                            <template v-if="campaign.type_selected === 2">
                                <template v-for="(single_category,index) in selected_categories">
                                    <tr :key="index" v-if="campaign.categories.indexOf(String(single_category.id)) != -1">
                                        ...
                                        <td>
                                            <!-- اضافة قيمة لكل منتج -->
                                            <input type="text" class="form-control" placeholder="القيمة التخفيض" v-model="privateValues[`${single_category.id}`]"/>
                                        </td>
                                    </tr>
                                </template>
                            </template>
